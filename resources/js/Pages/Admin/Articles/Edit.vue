...
<template>
    <AuthenticatedLayout>
        ...
        <div class="flex gap-6 mx-auto justify-center mt-16">
            <form @submit.prevent="submit" class="max-w-3xl w-1/2 bg-white rounded-md p-8">
            ...
            <div v-if="article.image" class="max-w-xl">
